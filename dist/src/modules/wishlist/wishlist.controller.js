...
let WishlistController = class WishlistController {
    ...
    async get(user) {
        ...
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Wishlist fetched', wishlist);
    }
    async add(user, productId) {
        const wishlist = await this.wishlistService.add(user.userId, productId);
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Added to wishlist', wishlist);
    }
    async remove(user, productId) {
        const wishlist = await this.wishlistService.remove(user.userId, productId);
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Removed from wishlist', wishlist);
    }
};
