...
let AuditLogController = class AuditLogController {
    ...
    async findAll(entityType, entityId, page = '1', limit = '50') {
        const result = await this.auditLogService.findAll({ entityType, entityId }, +page, +limit);
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Audit log fetched', result);
    }
};
