...
let CouponsController = class CouponsController {
    ...
    async create(dto) {
        ...
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.CREATED, 'Coupon created', coupon);
    }
    async findAll() {
        const coupons = await this.couponsService.findAll();
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Coupons fetched', coupons);
    }
    async update(id, dto) {
        const coupon = await this.couponsService.update(id, dto);
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Coupon updated', coupon);
    }
    async remove(id) {
        await this.couponsService.remove(id);
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Coupon deleted', null);
    }
    async validate(dto) {
        const { discount } = await this.couponsService.validate(dto.code, dto.cartSubtotal);
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Coupon is valid', { discount });
    }
};
