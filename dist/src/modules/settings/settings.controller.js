...
let SettingsController = class SettingsController {
    ...
    async get() {
        ...
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Settings fetched', settings);
    }
    async update(dto) {
        const settings = await this.settingsService.update(dto);
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Settings updated', settings);
    }
};
