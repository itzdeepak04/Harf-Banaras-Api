...
let DashboardController = class DashboardController {
    ...
    async adminSummary() {
        ...
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Admin dashboard fetched', summary);
    }
    async inventorySummary() {
        const summary = await this.dashboardService.inventorySummary();
        return (0, appresponse_shared_1.createResponse)(common_1.HttpStatus.OK, 'Inventory dashboard fetched', summary);
    }
};
...
], DashboardController.prototype, "adminSummary", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "inventorySummary", null);
